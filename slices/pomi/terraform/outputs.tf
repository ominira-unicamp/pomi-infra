...
output "openobserve_s3_bucket" { value = aws_s3_bucket.openobserve_logs.id }
output "openobserve_s3_access_key_parameter_name" { value = var.openobserve_s3_access_key_parameter_name }
output "openobserve_s3_secret_key_parameter_name" { value = var.openobserve_s3_secret_key_parameter_name }
output "openobserve_root_password_parameter_name" { value = var.openobserve_root_password_parameter_name }
